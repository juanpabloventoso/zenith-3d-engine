...
type
  ...
  Iz3DBoundingVolume = interface(Iz3DBase)['{DC8A50C3-E012-46BC-BD4F-8209B929E728}']
    function GetCenter: Iz3DFloat3; stdcall;
    function Intersects(const AVolume: Iz3DBoundingVolume): Boolean; overload; stdcall;
  ...
  Iz3DBoundingBox = interface(Iz3DBoundingVolume)['{AE5A1947-DE52-4C85-AC97-3CEF5B60CB05}']
    function GetDimensions: Iz3DFloat3; stdcall;
    property Dimensions: Iz3DFloat3 read GetDimensions;
  end;

  Iz3DBoundingSphere = interface(Iz3DBoundingVolume)['{8E182B3F-709B-4F24-A44D-A1C70DB65897}']
